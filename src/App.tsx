...
function App() {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0f]">
      ...
      <a href="https://wa.me/919655058949?text=Hello%20Vexorix%20👋%0A%0AI%20saw%20your%20website%20and%20I'm%20interested%20in%20building%20a%20professional%20solution%20for%20my%20business.%0A%0APlease%20contact%20me%20regarding:%0A•%20Project%20discussion%0A•%20Pricing%0A•%20Demo%20availability.%0A%0AThank%20you." target="_blank" rel="noopener noreferrer" className="fixed bottom-6 left-6 w-14 h-14 bg-green-500 rounded-full flex items-center justify-center text-2xl shadow-lg hover:scale-110 transition-transform z-40" aria-label="WhatsApp">
