...
const projects = [
  { id: 1, category: 'Business', title: 'Restaurant Website', img: '/images/restaurant.jpg', tech: ['React', 'Node.js', 'MongoDB'], desc: 'Online reservation-enabled restaurant website designed to improve customer engagement and increase bookings.', demo: 'https://u-me-couple-cafe.vercel.app/' },
  { id: 2, category: 'Healthcare', title: 'Hospital Management System', img: '/images/hospital.jpg', tech: ['React', 'Node.js', 'MySQL'], desc: 'Smart hospital management system simplifying appointments, doctor scheduling, and patient communication.', demo: 'https://hospital-system-management.vercel.app/' },
  { id: 3, category: 'E-commerce', title: 'Department Store', img: '/images/department-store.jpg', tech: ['React', 'Node.js', 'PostgreSQL'], desc: 'Conversion-focused online store with structured catalog, cart system, and smooth checkout experience.', demo: '#' },
  { id: 4, category: 'Portfolio', title: 'Photography Portfolio', img: '/images/photography.jpg', tech: ['React', 'TypeScript'], desc: 'Visually rich portfolio designed to attract clients and showcase professional photography work.', demo: 'https://vicky-photography.vercel.app/' },
  { id: 5, category: 'Fitness', title: 'Gym & Fitness Website', img: '/images/gym.jpg', tech: ['React', 'Node.js', 'MongoDB'], desc: 'High-conversion fitness website to boost memberships and highlight training programs.', demo: 'https://vikramgym.vercel.app/' },
  { id: 6, category: 'Events', title: 'Event Management', img: '/images/event.jpg', tech: ['React', 'Node.js', 'MySQL'], desc: 'Complete event booking platform built to generate leads and streamline event management.', demo: 'https://atozevent.netlify.app/' },
  { id: 7, category: 'Real Estate', title: 'Real Estate Website', img: '/images/realestate.jpg', tech: ['React', 'Node.js', 'PostgreSQL'], desc: 'Modern real estate platform for showcasing properties and capturing buyer enquiries.', demo: 'https://real-estate-project-rose-tau.vercel.app/' },
  { id: 8, category: 'Business', title: 'Business Website', img: '/images/business.jpg', tech: ['React', 'Node.js', 'MongoDB'], desc: 'Professional business website designed for new companies to establish a strong online presence, showcase services, and attract potential clients from day one.', demo: '#' },
]
